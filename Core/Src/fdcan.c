...
/* USER CODE BEGIN 0 */
uint32_t check_fdcan1_RAM_Offset;    /* ����fdcan1ռ��RAM�Ĵ�С(��������fdcan2��MessageRAMOffset) (check_fdcan1_RAM_Offset = hfdcan1.msgRam.EndAddress - SRAMCAN_BASE)*/
uint32_t check_fdcan2_RAM_Offset;    /* ����fdcan1��fdcan2ռ��RAM�Ĵ�С(��������fdcan3��MessageRAMOffset) (check_fdcan2_RAM_Offset = hfdcan2.msgRam.EndAddress - SRAMCAN_BASE)*/
uint32_t check_fdcan3_RAM_Offset;    /* ����fdcan1��fdcan2��fdcan3ռ��RAM�Ĵ�С (check_fdcan3_RAM_Offset = hfdcan3.msgRam.EndAddress - SRAMCAN_BASE)*/
/* USER CODE END 0 */
...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.MessageRAMOffset = 180;
